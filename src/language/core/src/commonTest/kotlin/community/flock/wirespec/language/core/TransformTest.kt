...
class TransformTest {
    ...
    fun transformShouldRenameCustomType() {
        ...
        val result = struct.renameType("Address", "Location") as Struct
    ...
    fun transformShouldRenameTypeInDict() {
        ...
        val result = struct.renameType("Item", "Product") as Struct
    ...
    fun transformShouldRenameField() {
        ...
        val result = struct.renameField("firstName", "givenName") as Struct
    ...
    fun transformMatchingShouldTransformSpecificType() {
        ...
        val result = struct.transformMatching<Type.Array> { array ->
    ...
    fun transformShouldHandleDeeplyNestedStructures() {
        ...
        val result = file.renameType("Value", "Data") as File
    ...
    fun transformShouldHandleFunctionParametersAndReturnTypes() {
        ...
        val result = function.renameType("Input", "Request")
            .renameType("Output", "Response") as Function
    ...
    fun customTransformerShouldAllowComplexTransformations() {
        ...
        val result = struct.transform(transformer) as Struct
    ...
    fun transformShouldHandleStatementsWithExpressions() {
        ...
        val result = function.renameType("Result", "Response") as Function
    ...
    fun transformShouldHandleSwitchStatements() {
        ...
        val result = function.renameType("Output", "Result") as Function
