...
<Tabs>
  <TabItem value="kotin" label="Kotlin">
    ```kotlin
    val objectMapper = ObjectMapper().registerModule(WirespecModuleJava())
    ```
  </TabItem>
  <TabItem value="java" label="Java">
    ```java
    ObjectMapper objectMapper = new ObjectMapper().registerModule(new WirespecModuleJava())
    ```
  </TabItem>
</Tabs>
val mapper = ObjectMapper.registerModule(WirespecModuleKotlin())
