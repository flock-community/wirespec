...
Your application code can now make RPCs or interact with your message broker in a type-safe way.
...
```java
@Service
public class NotificationService implements NotificationQueueChannel {

    private static final String TOPIC = "my-topic";

    private final ProducerFactory<Object, Object> kafkaProducerFactory;

    public NotificationService(ProducerFactory<Object, Object> kafkaProducerFactory) {
...
public class NotificationService {
    ...
    public NotificationService(ConsumerFactory<Object, Object> kafkaConsumerFactory) {
    ...
    public void listen(String groupId, Task listener) {
        ...
        KafkaMessageListenerContainer<Object, Object> container = new KafkaMessageListenerContainer<>(kafkaConsumerFactory, containerProps);
