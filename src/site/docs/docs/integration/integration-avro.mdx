...
<Tabs>
    ...
    <TabItem value="gradle-java" label="Gradle (Java)">
        ...
        ```kotlin
        dependencies {
            implementation("community.flock.wirespec.integration:avro-jvm:{{WIRESPEC_VERSION}}")
        }
        ...
        tasks.register<CompileWirespecTask>("wirespec-avro-java") {
            ...
            languages = listOf(community.flock.wirespec.plugin.Language.Java)
            ir = true
            extensionClasses = listOf(community.flock.wirespec.integration.avro.extension.AvroExtension::class.java)
        }
        ```
    ...
    <TabItem value="gradle-kotlin" label="Gradle (Kotlin)">
        ...
        tasks.register<CompileWirespecTask>("wirespec-avro-kotlin") {
            ...
            output = layout.buildDirectory.dir("generated-sources")
            packageName = "community.flock.wirespec.generated"
            languages = listOf(community.flock.wirespec.plugin.Language.Kotlin)
            ir = true
            extensionClasses = listOf(community.flock.wirespec.integration.avro.extension.AvroExtension::class.java)
        }
        ```
...
<Tabs groupId="language">
    <TabItem value="java" label="Java">
        ```java title="generated-sources/community/flock/wirespec/generated/channel/NotificationQueue.java"
        package community.flock.wirespec.generated.channel;

        import community.flock.wirespec.java.Wirespec;

        public interface NotificationQueue extends Wirespec.Channel {
            public interface Sender {
                public void notificationQueue(community.flock.wirespec.generated.model.Task message);
            }
            public interface Listener {
                public void notificationQueue(java.util.function.Function<community.flock.wirespec.generated.model.Task, Void> handler);
            }
        }
        ```

        The model is emitted by the Java IR emitter, and the Avro schema + converter live in a
        separate `TaskAvro` class added by the `AvroExtension`:

        ```java title="generated-sources/community/flock/wirespec/generated/model/Task.java"
        ...
        ```java title="generated-sources/community/flock/wirespec/generated/avro/TaskAvro.java"
        package community.flock.wirespec.generated.avro;

        import community.flock.wirespec.generated.model.Task;

        public class TaskAvro {
            public static final org.apache.avro.Schema SCHEMA =
                new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Task\",\"namespace\":\"community.flock.wirespec.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"content\",\"type\":\"string\"}]}");
    ...
    <TabItem value="kotlin" label="Kotlin">
        ```kotlin title="generated-sources/community/flock/wirespec/generated/channel/NotificationQueue.kt"
        package community.flock.wirespec.generated.channel

        import community.flock.wirespec.kotlin.Wirespec

        interface NotificationQueue : Wirespec.Channel {
            interface Sender {
                fun notificationQueue(message: community.flock.wirespec.generated.model.Task)
            }
            interface Listener {
                fun notificationQueue(handler: (community.flock.wirespec.generated.model.Task) -> Unit)
            }
        }
        ```

        The model is emitted by the Kotlin IR emitter, and the Avro schema + converter live in a
        separate `TaskAvro` object added by the `AvroExtension`:

        ```kotlin title="generated-sources/community/flock/wirespec/generated/model/Task.kt"
        package community.flock.wirespec.generated.model
        ...
        ```kotlin title="generated-sources/community/flock/wirespec/generated/avro/TaskAvro.kt"
        package community.flock.wirespec.generated.avro

        import community.flock.wirespec.generated.model.Task

        object TaskAvro {
            val SCHEMA = org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Task\",\"namespace\":\"community.flock.wirespec.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"content\",\"type\":\"string\"}]}")
...
<Tabs groupId="language">
    <TabItem value="java" label="Java">
        ```java
        @Service
        public class NotificationProducer implements NotificationQueue.Sender {
            ...
            @Override
            public void notificationQueue(Task message) {
                KafkaTemplate<Object, Object> template = new KafkaTemplate<>(kafkaProducerFactory);
                GenericData.Record avro = TaskAvro.to(message);
    ...
    <TabItem value="kotlin" label="Kotlin">
        ...
        class NotificationProducer(
            ...
            override fun notificationQueue(message: Task) {
                val template = KafkaTemplate(kafkaProducerFactory)
                val avro = TaskAvro.to(message)
...
<Tabs groupId="language">
    <TabItem value="java" label="Java">
        ...
        public class NotificationConsumer {
            ...
            public void listen(String groupId, java.util.function.Consumer<Task> listener) {
                ...
                container.setupMessageListener((MessageListener<String, GenericData.Record>) data -> {
                    Task task = TaskAvro.from(data.value());
    ...
    <TabItem value="kotlin" label="Kotlin">
        ...
        class NotificationConsumer(private val kafkaConsumerFactory: ConsumerFactory<Any, Any>) {
            ...
            fun listen(groupId: String, listener: (Task) -> Unit) {
                ...
                container.setupMessageListener(MessageListener { data: ConsumerRecord<String?, GenericData.Record?> ->
                    val task = TaskAvro.from(data.value())
                    listener(task)
                })
                container.start()
            }
