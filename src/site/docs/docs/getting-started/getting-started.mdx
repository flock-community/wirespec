...
means that the API's structure and behavior are defined *before* any code is written, ensuring a shared understanding
...
<Tabs>
    <TabItem value="TypeScript" label="TypeScript">
        ```bash
        wirespec compile --language typescript --input .
        ```
    ...
    <TabItem value="Kotlin" label="Kotlin">
        ```bash
        wirespec compile --language kotlin --input .
        ```
    ...
    <TabItem value="Java" label="Java">
        ```bash
        wirespec compile --language java --input .
        ```
...
Once you've plugged in your HTTP client you are now guaranteed(?) to adhere to the contract.
(TODO we don't really guarantee anything of course, and is this list exhaustive?)
...
<div style={{ display: 'flex', gap: '20px' }}>  {}
    ...
    <div style={{ flex: '1', border: '1px solid #ccc', padding: '15px', borderRadius: '5px' }}>
        <h3>Hooking up a HTTP client</h3>
        <p>Explore different ways to hook up your HTTP client.</p>
        <a href="/docs/integration">Read More</a>
    </div>
    <div style={{ flex: '1', border: '1px solid #ccc', padding: '15px', borderRadius: '5px' }}>
        <h3>Validation?</h3>
        <p>Automated testing of Wirespec definitions and generated code. (?).</p>
        <a href="/docs/integration">Read More</a>
    </div>
</div>
