...
need to write an [IR extension](../plugins/plugins.md#ir-extensions) to make use of these annotations:
...
You can specify a [type](types) for the request body by appending the resource type after the HTTP method like so:
