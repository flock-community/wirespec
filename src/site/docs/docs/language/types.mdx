...
Types can be annotated to provide metadata for code generation or validation:
...
Fields within composite types can also be annotated to provide metadata for individual fields:
