...
- `transformerClasses`: ListProperty&lt;Class&lt;\*&gt;&gt; - `IrTransformer` classes applied to the intermediate representation before code generation when an emitter is an `IrEmitter`
