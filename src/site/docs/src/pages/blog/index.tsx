...
const blogPosts = [
  {
    ...
    subtitle: 'In the fast-paced world of financial services, having consistent and efficient APIs and SDKs is crucial.',
    link: '/blog-detail',
  },
  {
    image: '/img/code-snippet.png',
    title: 'Building a Scalable API Platform for FinTech',
    subtitle: 'Discover how streamlined contract-first APIs helped reduce technical debt and increased developer agility.',
    link: '/blog-detail',
  },
  {
    image: '/img/code-snippet.png',
    title: 'API Reliability at Scale: Lessons from High-Traffic Systems',
    subtitle: 'We explore patterns and pitfalls in scaling APIs to handle millions of requests with resilience.',
    link: '/blog-detail',
  },
  {
    image: '/img/code-snippet.png',
    title: 'Accelerating API Development with Wirespec',
    subtitle: 'Speeding up dev cycles and maintaining quality using codegen from contract specifications.',
    link: '/blog-detail',
  },
];
...
export default function BlogPage() {
  return (
    <Layout title="Blog" description="Latest blog posts and case studies">
