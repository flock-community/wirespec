package community.flock.wirespec.integration.wiremock.java.generated.endpoint;
...
public interface GetTodoById extends Wirespec.Endpoint {
  ...
  record Response404(
    ...
    Headers headers,
    Error body
  ) implements Response4XX<Error>, ResponseError {
    public Response404(Error body) {
      this(404, new Headers(), body);
    }
    static class Headers implements Wirespec.Response.Headers {}
  }
  ...
  interface Handler extends Wirespec.Handler {
    ...
    static Wirespec.RawResponse toResponse(Wirespec.Serializer serialization, Response<?> response) {
      ...
      if (response instanceof Response404 r) { return new Wirespec.RawResponse(r.status(), java.util.Collections.emptyMap(), java.util.Optional.ofNullable(serialization.serializeBody(r.body, Wirespec.getType(Error.class, null)))); }
