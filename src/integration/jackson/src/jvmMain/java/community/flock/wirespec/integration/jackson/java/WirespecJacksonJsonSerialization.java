 ...
 */
public class WirespecJacksonJsonSerialization implements Serialization, DefaultParamSerialization, DefaultPathSerialization {

    private final ObjectMapper wirespecObjectMapper;

    public WirespecJacksonJsonSerialization(ObjectMapper objectMapper) {
        this.wirespecObjectMapper = objectMapper.copy().registerModule(new WirespecJacksonJsonModuleJava());
    }
