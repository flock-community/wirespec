...
open class WirespecSerializationConfiguration {
    ...
    @Bean
    open fun wirespecSerialization(objectMapper: ObjectMapper, paramSerde: DefaultParamSerialization): Wirespec.Serialization<String> = object : Wirespec.Serialization<String>, Wirespec.ParamSerialization by paramSerde {
