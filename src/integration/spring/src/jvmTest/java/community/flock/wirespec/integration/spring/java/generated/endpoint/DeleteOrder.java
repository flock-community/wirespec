...
public interface DeleteOrder extends Wirespec.Endpoint {
  ...
  public interface Handler extends Wirespec.Handler {
    @org.springframework.web.bind.annotation.DeleteMapping("/store/order/{orderId}")  public java.util.concurrent.CompletableFuture<Response<?>> deleteOrder(Request request);
  ...
  public interface Call extends Wirespec.Call {
    public java.util.concurrent.CompletableFuture<Response<?>> deleteOrder(Long orderId);
  }
