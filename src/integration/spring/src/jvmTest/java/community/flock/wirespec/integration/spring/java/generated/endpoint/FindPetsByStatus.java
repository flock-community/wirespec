...
public interface FindPetsByStatus extends Wirespec.Endpoint {
  ...
  public static Wirespec.RawRequest toRawRequest(Wirespec.Serializer serialization, Request request) {
    return new Wirespec.RawRequest(
      ...
      java.util.Map.ofEntries(java.util.Map.entry("status", request.queries().status().map(it -> serialization.<FindPetsByStatusParameterStatus>serializeParam(it, Wirespec.getType(FindPetsByStatusParameterStatus.class, null))).orElse(java.util.List.<String>of()))),
      java.util.Collections.emptyMap(),
      java.util.Optional.empty()
    );
  }
  public static Request fromRawRequest(Wirespec.Deserializer serialization, Wirespec.RawRequest request) {
    return new Request(java.util.Optional.ofNullable(request.queries().get("status")).map(it -> serialization.<FindPetsByStatusParameterStatus>deserializeParam(it, Wirespec.getType(FindPetsByStatusParameterStatus.class, null))));
  }
  ...
  public interface Handler extends Wirespec.Handler {
    @org.springframework.web.bind.annotation.GetMapping("/pet/findByStatus")  public java.util.concurrent.CompletableFuture<Response<?>> findPetsByStatus(Request request);
  ...
  public interface Call extends Wirespec.Call {
    public java.util.concurrent.CompletableFuture<Response<?>> findPetsByStatus(java.util.Optional<FindPetsByStatusParameterStatus> status);
  }
