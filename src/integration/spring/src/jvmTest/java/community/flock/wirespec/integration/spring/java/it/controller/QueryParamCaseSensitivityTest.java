...
public class QueryParamCaseSensitivityTest {
    ...
    public void shouldHandleQueryParamsCaseSensitively(String queryParam, String randomQuery, boolean shouldSucceed) {
        String body = "{\"number\": 1, \"string\": \"test\"}";

        WebTestClient.ResponseSpec result = client
                .post()
