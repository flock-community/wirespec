...
public interface PlaceOrder extends Wirespec.Endpoint {
  ...
  public static Wirespec.RawRequest toRawRequest(Wirespec.Serializer serialization, Request request) {
    return new Wirespec.RawRequest(
      ...
      java.util.Collections.emptyMap(),
      java.util.Optional.of(serialization.<Order>serializeBody(request.body(), Wirespec.getType(Order.class, null)))
    );
  }
  public static Request fromRawRequest(Wirespec.Deserializer serialization, Wirespec.RawRequest request) {
    return new Request(request.body().map(it -> serialization.<Order>deserializeBody(it, Wirespec.getType(Order.class, null))).orElseThrow(() -> new IllegalStateException("body is null")));
  }
  ...
  public interface Handler extends Wirespec.Handler {
    @org.springframework.web.bind.annotation.PostMapping("/store/order")  public java.util.concurrent.CompletableFuture<Response<?>> placeOrder(Request request);
  ...
  public interface Call extends Wirespec.Call {
    public java.util.concurrent.CompletableFuture<Response<?>> placeOrder(Order body);
  }
