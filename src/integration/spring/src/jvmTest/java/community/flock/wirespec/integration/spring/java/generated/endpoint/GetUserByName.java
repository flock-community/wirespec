...
public interface GetUserByName extends Wirespec.Endpoint {
  ...
  public sealed interface Response<T> extends Wirespec.Response<T> permits Response2XX, Response4XX, ResponseUser, ResponseUnit {}
  ...
  public interface Handler extends Wirespec.Handler {
    @org.springframework.web.bind.annotation.GetMapping("/user/{username}")  public java.util.concurrent.CompletableFuture<Response<?>> getUserByName(Request request);
  ...
  public interface Call extends Wirespec.Call {
    public java.util.concurrent.CompletableFuture<Response<?>> getUserByName(String username);
  }
