...
public interface UpdatePet extends Wirespec.Endpoint {
  ...
  public sealed interface Response4XX<T> extends Response<T> permits Response400, Response404, Response405 {}
  public sealed interface ResponsePet extends Response<Pet> permits Response200 {}
  public sealed interface ResponseUnit extends Response<Void> permits Response400, Response404, Response405 {}
  ...
  public interface Handler extends Wirespec.Handler {
    @org.springframework.web.bind.annotation.PutMapping("/pet")  public java.util.concurrent.CompletableFuture<Response<?>> updatePet(Request request);
  ...
  public interface Call extends Wirespec.Call {
    public java.util.concurrent.CompletableFuture<Response<?>> updatePet(Pet body);
  }
