...
object AvroEmitter : Emitter() {
    ...
    fun Reference.emit(module: Module, hasEmitted: MutableList<String>): AvroModel.Type {
        println("excellent emitting")
        println(module.uri)
    ...
    fun Type.emit(module: Module, hasEmitted: MutableList<String>): AvroModel.RecordType {
        println("more")
