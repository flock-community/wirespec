...
emitterFixtures {
    language = "kotlin"
    emitterPackage = "community.flock.wirespec.emitters.kotlin"
    emitterClass = "KotlinIrEmitter"
    generatorClass = "community.flock.wirespec.ir.generator.KotlinGenerator"
