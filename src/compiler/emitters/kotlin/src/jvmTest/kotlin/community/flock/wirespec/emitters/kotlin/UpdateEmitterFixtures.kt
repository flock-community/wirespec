...
private fun compile(fixture: Fixture): String = fixture.compiler { KotlinIrEmitter() }.fold(
    { error("Failed to compile fixture: $it") },
    { it },
)

private fun shared(): String = KotlinIrEmitter(emitShared = EmitShared(true)).emitShared()?.let(KotlinGenerator::generate) ?: error("Shared emit returned null")
