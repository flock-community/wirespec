...
private const val LANGUAGE = "typescript"

private val emitContext = object : EmitContext, NoLogger {
    override val emitters = nonEmptySetOf(TypeScriptIrEmitter())
}
...
private fun compile(fixture: Fixture): String = fixture.compiler { TypeScriptIrEmitter() }.fold(
    { error("Failed to compile fixture: $it") },
    { it },
)

private fun shared(): String = TypeScriptIrEmitter().emitShared()?.let(TypeScriptGenerator::generate) ?: error("Shared emit returned null")
