...
val allCompileTests = listOf(
    CompileTest("compileFullEndpointTest", "FullEndpoint", FixtureSources.fullEndpoint),
    CompileTest("compileChannelTest", "Channel", FixtureSources.channel),
    CompileTest("compileEnumTest", "Enum", FixtureSources.enum),
    CompileTest("compileMinimalEndpointTest", "MinimalEndpoint", FixtureSources.minimalEndpoint),
    CompileTest("compileRefinedTest", "Refined", FixtureSources.refined),
    CompileTest("compileUnionTest", "Union", FixtureSources.union),
    CompileTest("compileTypeTest", "Type", FixtureSources.type),
)
