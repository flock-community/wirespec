...
val allCompileTests = listOf(
    ...
    CompileTest("compileNestedTypeTest", "NestedType", CompileNestedTypeTest.source),
    CompileTest("compileComplexModelTest", "ComplexModel", CompileComplexModelTest.source),
)
