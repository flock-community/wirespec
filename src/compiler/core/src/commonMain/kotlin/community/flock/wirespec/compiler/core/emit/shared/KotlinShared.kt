...
data object KotlinShared : Shared {
    ...
    override val source = """
        ...
        |${Spacer}interface Serialization<RAW : Any> : Serializer<RAW>, Deserializer<RAW>, QueryParamSerialization
        |${Spacer}interface QueryParamSerialization: QueryParamSerializer, QueryParamDeserializer
        |${Spacer}interface QueryParamSerializer { fun <T> serializeQuery(value: T, kType: KType): List<String> }
        ...
        |${Spacer}interface QueryParamDeserializer { fun <T> deserializeQuery(values: List<String>, kType: KType): T }
