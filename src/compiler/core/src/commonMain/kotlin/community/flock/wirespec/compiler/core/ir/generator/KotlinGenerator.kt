...
import community.flock.wirespec.compiler.core.ir.core.Cast
import community.flock.wirespec.compiler.core.ir.core.ClassReference
import community.flock.wirespec.compiler.core.ir.core.Constraint
...
import community.flock.wirespec.compiler.core.ir.core.Lambda
...
import community.flock.wirespec.compiler.core.ir.core.PrintStatement
...
import community.flock.wirespec.compiler.core.ir.core.TypeParameter
...
import community.flock.wirespec.compiler.core.ir.core.annotatedFields
import community.flock.wirespec.compiler.core.ir.core.fieldList
import community.flock.wirespec.compiler.core.ir.core.Function as AstFunction
...
public object KotlinGenerator :
    ...
    private fun Struct.emitPlainClass(indent: Int, parents: List<Element>): String {
        ...
        val header = "$annotationPrefix$visibilityPrefix" + "class $name$typeParamsStr$ctorStr$implStr"
        return if (content.isEmpty()) {
            "$header\n\n".indentCode(indent)
        } else {
            "$header {\n$content${"}".indentCode(0)}\n\n".indentCode(indent)
