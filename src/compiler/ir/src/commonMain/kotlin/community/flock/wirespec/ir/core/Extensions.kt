...
public inline fun <reified T : HasElements> T.plus(element: Element): T = when (this) {
...
public inline fun <reified T : HasElements> Element.plus(elements: T): T = when (elements) {
