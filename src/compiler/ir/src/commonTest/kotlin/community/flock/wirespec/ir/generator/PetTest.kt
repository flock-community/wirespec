...
class PetTest {
    ...
    fun getTodos() {
        val getTodos = file("GetTodos") {
            ...
            namespace("GetTodos", type("Wirespec.Endpoint")) {
                struct("Path") {
                ...
                struct("Request") {
                    ...
                    constructo {
                        ...
                        assign("method", EnumReference(Type.Custom("Wirespec.Method"), Name.of("GET")))
                        assign(
                            "queries",
                                        ...
                                        mapOf(
                                            "done" to NullCheck(
                                                ...
                                                body = functionCall("serialization.serializeParam") {
                                                    ...
                                                    arg(
                                                        "type",
                                                        functionCall("getType", receiver = RawExpression("Wirespec")) {
        ...
        assertTrue(output.contains("java.util.Map.ofEntries(java.util.Map.entry(\"done\", java.util.Optional.ofNullable(request.queries.done).map(it -> serialization.serializeParam(it, Wirespec.getType(Boolean.class, java.util.Optional.class))).orElse(java.util.List.<String>of())))"))
