...
class Serialization(
    ...
    override fun <T : Any> serializeBody(
        t: T,
        kType: KType,
    ): ByteArray = objectMapper.writeValueAsBytes(t)
    ...
    override fun <T : Any> serializeParam(
        value: T,
        kType: KType,
    ): List<String> = defaultParamSerialization.serializeParam(value, kType)

    override fun <T : Any> deserializeParam(
        values: List<String>,
        kType: KType,
    ): T = defaultParamSerialization.deserializeParam(values, kType)
}
