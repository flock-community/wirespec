...
import community.flock.wirespec.examples.kotest.scenario.CampaignScenarioSpec
 ...
 */
class CampaignChannelScenarioTest : CampaignScenarioSpec() {
    init {
        ...
        test("an event sent through the DSL is consumed by the application listener") {
            ...
            val listener = application().getBean(CampaignEventConsumer::class.java)
