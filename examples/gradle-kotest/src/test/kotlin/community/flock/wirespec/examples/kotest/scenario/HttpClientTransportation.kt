...
/**
 * A [Wirespec.Transportation] that executes the raw request against the running
 * Spring app over real HTTP, using the JDK [HttpClient]. The scenario DSL's typed
 * client edge turns a generated `Request` into a [Wirespec.RawRequest]; this sends
 * it and maps the HTTP response back into a [Wirespec.RawResponse].
 */
