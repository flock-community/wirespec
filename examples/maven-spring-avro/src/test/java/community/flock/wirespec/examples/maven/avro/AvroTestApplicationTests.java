...
class AvroTestApplicationTests {
    ...
    private static final KafkaContainer KAFKA_CONTAINER =
            new KafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:7.7.1")).withNetwork(NETWORK);

    @Container
    private static final GenericContainer SCHEMA_CONTAINER = new GenericContainer(
    ...
    private static final Supplier<String> schemaUrl =
            () -> "http://" + SCHEMA_CONTAINER.getHost() + ":" + SCHEMA_CONTAINER.getFirstMappedPort();
