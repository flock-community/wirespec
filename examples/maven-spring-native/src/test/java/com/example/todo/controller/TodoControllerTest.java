...
class TodoControllerTest {
    ...
    void deleteTodo_deletesExistingTodo() throws Exception {
        ...
        assertThat(mvc.delete().uri("/api/todos/{id}", id).exchange()).hasStatus(HttpStatus.NO_CONTENT);

        assertThat(mvc.get().uri("/api/todos/{id}", id).exchange()).hasStatus(HttpStatus.NOT_FOUND);
    }
