...
abstract class AbstractFile(private val path: String) {

    companion object {
        private const val bufferLength = 64 * 1024
    }

    fun read() = StringBuilder().apply {
    ...
    fun write(text: String) {
        val file = fopen(path, "w") ?: throw FileReadException("Cannot open output file $path")
        try {
            memScoped {
